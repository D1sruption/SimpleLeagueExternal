...
public:
	...
	GameObjectManager(DWORD offset) {
		base = offset;
		ReadProcessMemory(handle, (void*)(offset + 0x8), (PBYTE)&maxObjects, sizeof(maxObjects), 0);
		ReadProcessMemory(handle, (void*)(offset + 0xC), (PBYTE)&size, sizeof(size), 0);
		ReadProcessMemory(handle, (void*)(offset + 0x14), (PBYTE)&objects, sizeof(objects), 0);
	}
};
